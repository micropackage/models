	...
	protected static function getLabelTemplates(): array
	{
		return array_merge(
			[
				...
				'add_new_item' => sprintf(__('Add New %s', 'micropackage-wp-objects'), '{singular}'),
				/* translators: %s is a post type or taxonomy name. */
				...
				'item_link_description' => sprintf(
					/* translators: %s is a post type or taxonomy name. */
					_x('A link to a %s.', 'navigation link block description', 'micropackage-wp-objects'),
					'{singularLower}'
				),
				/* translators: %s is a post type or taxonomy name. */
				'items_list' => sprintf(__('%s list', 'micropackage-wp-objects'), '{plural}'),
				/* translators: %s is a post type or taxonomy name. */
				'items_list_navigation' => sprintf(__('%s list navigation', 'micropackage-wp-objects'), '{plural}'),
				'name' => '{plural}',
				/* translators: %s is a post type or taxonomy name. */
				'not_found' => sprintf(__('No %s found.', 'micropackage-wp-objects'), '{pluralLower}'),
				/* translators: %s is a post type or taxonomy name. */
				'parent_item_colon' => sprintf(__('Parent %s:', 'micropackage-wp-objects'), '{singular}'),
				/* translators: %s is a post type or taxonomy name. */
				'search_items' => sprintf(__('Search %s', 'micropackage-wp-objects'), '{plural}'),
				'singular_name' => '{singular}',
				/* translators: %s is a post type or taxonomy name. */
				'view_item' => sprintf(__('View %s', 'micropackage-wp-objects'), '{singular}'),
			],
